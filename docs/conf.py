# -*- coding: utf-8 -*-
#
# django-environments documentation build configuration file, created by
# sphinx-quickstart on Wed Feb 11 00:29:33 2015.
#
...
# built documents.
#
version = release = __import__('djenv').__version__
...
htmlhelp_basename = 'django-environmentsdoc'
...
latex_documents = [
  ('index', 'django-environments.tex', u'django-environments Documentation',
   u'Goeie Jongens', 'manual'),
]
...
man_pages = [
    ('index', 'django-environments', u'django-environments Documentation',
     [u'Goeie Jongens'], 1)
]
...
texinfo_documents = [
  ('index', 'django-environments', u'django-environments Documentation',
   u'Goeie Jongens', 'django-environments', 'One line description of project.',
   'Miscellaneous'),
]
